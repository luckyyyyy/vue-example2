    ...
    <div class="control">
        <div class="left">
            <div class="button-address">
                ...
                <el-popover ref="push-popover" placement="bottom-start" width="200" trigger="click">
                    <p>扫码开启直播</p>
                    <div class="qrcode"></div>
                    <copy-board btn_class="copy_push" copy_str="rtmp://pub.mudu.tv/watch/f4aj52"></copy-board>
                </el-popover>
                <el-button v-popover:push-popover>推流地址</el-button>
                <el-popover ref="play-popover" placement="bottom-start" width="200" trigger="click">
                    <p>微信扫码观看直播</p>
                    <div class="qrcode"></div>
                    <copy-board btn_class="copy_play" copy_str="rtmp://pub.mudu.tv/watch/f4aj52"></copy-board>
                </el-popover>
                <el-button v-popover:play-popover>观看地址</el-button>
            </div>
            <div class="button-action">
                <el-button type="primary" @click="notice_dialog_visible = true">公告</el-button>
